            ...
            <div className="gallery">
                    {
                        data.map((posts) => {
                            return (
                               <div className="card">
                                <hr />
                                <p>NAME : {posts?.postedBy?.name}</p>
                                <p>ADDRESS :{posts?.postedBy?.address}</p>
                                <p>PHONE : {posts?.postedBy?.phone}</p>
                                <p>QUERY : {posts.body}</p>

                                <button className="delete" onClick={() => {removePost(posts._id)}}>Solved</button>
                                <hr />                                
                                <br />
                                <br />
                                <br />
